# ![LOGO](logo.png) AWS Auto Scaling Plans MSP Connector

## Description

A generated MSP connector for the AWS Auto Scaling Plans API (version 2018-01-06).
...
flowground :- Telekom iPaaS / amazonaws-com-autoscaling-plans-connector<br/>
